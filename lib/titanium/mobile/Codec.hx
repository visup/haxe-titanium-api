...
http://developer.appcelerator.com/apidoc/mobile/1.7.0.RC1/Titanium.Codec.encodeNumber-method.html
...
extern class Codec
{
	...
	public static var CHARSET_ISO_LATIN1:String;
	...
	public static var BIG_ENDIAN:Int; 
	public static var LITTLE_ENDIAN:Int; 
	
	// static methods
	public static function getNativeByteOrder():Int;
	public static function encodeNumber(option:Dynamic):Int;
	public static function decodeNumber(option:Dynamic):Int;
	public static function encodeString(option:Dynamic):Int;
	public static function decodeString(option:Dynamic):String;
