...
http://developer.appcelerator.com/apidoc/mobile/1.7.0.RC1/Titanium.Buffer-object.html
...
extern class Buffer
{
 ...
 // methods
 public function append(sourceBuffer:Buffer, ?sourceOffset:Int, ?sourceLength:Int):Int;
 public function insert(sourceBuffer:Buffer, offset:Int, ?sourceOffset:Int, ?sourceLength:Int):Int;
 public function copy(sourceBuffer:Buffer, offset:Int, ?sourceOffset:Int, ?sourceLength:Int):Int;
 public function clone(?offset:Int, ?length:Int):Buffer;
 public function fill(fillByte:Int, ?offset:Int, ?length:Int):Void;
