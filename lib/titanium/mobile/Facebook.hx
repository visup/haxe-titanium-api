...
extern class Facebook
{
	...
	public static function createLoginButton(parameters:Dynamic):FacebookLoginButton;
	public static function authorize():Void;
	public static function logout():Void;
	public static function requestWithGraphPath(path:String, params:Dynamic, httpMethod:String, callBack:Dynamic->Void):Void;
	public static function request(method:String, params:Dynamic, callBack:Dynamic->Void):Void;
	public static function dialog(action:String, params:Dynamic, callBack:Dynamic->Void):Void; 
}