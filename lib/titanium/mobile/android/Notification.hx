...
http://developer.appcelerator.com/apidoc/mobile/latest/Titanium.Android.Notification-object
...
{
	// static constructor
	public inline static function create(options:Dynamic):Notification
		return titanium.mobile.Android.createNotification(options)
	...
	// methods
	public function setLatestEventInfo(?options:Dynamic):Void;
}
#end