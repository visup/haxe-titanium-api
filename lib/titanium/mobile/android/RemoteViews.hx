...
http://developer.appcelerator.com/apidoc/mobile/latest/Titanium.Android.RemoteViews-object
...
{
	// static constructor
	public inline static function create(?options:Dynamic):RemoteViews
		return titanium.mobile.Android.createRemoteViews(options)

	// methods
	public function setBoolean(viewId:Int, methodName:String, value:Bool):Void;
	public function setDouble(viewId:Int, methodName:String, value:Float):Void;
	public function setInt(viewId:Int, methodName:String, value:Int):Void;
	public function setString(viewId:Int, methodName:String, value:String):Void;
	public function setUri(viewId:Int, methodName:String, value:String):Void;
	public function setImageViewResource(viewId:Int, srcId:Int):Void;
	public function setImageViewUri(viewId:Int, uri:String):Void;
	public function setOnClickPendingIntent(viewId:Int, pendingIntent:PendingIntent):Void;
	public function setProgressBar(viewId:Int, max:Int, progress:Int, indeterminate:Bool):Void;
	public function setTextColor(viewId:Int, color:Int):Void;
	public function setTextViewText(viewId:Int, text:String):Void;
	public function setViewVisibility(viewId:Int, visibility:Int):Void;
	public function setChronometer(viewId:Int, base:Date, format:String, started:Bool):Void;
